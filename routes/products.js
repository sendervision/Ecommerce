...
productRoute.get('/get/count', async (req, res) => {
...
productRoute.get('/get/featured/:count', async (req, res) => {
...
productRoute.put('/gallery-images/:id', upload.array('images', 10), async (req, res) => {
